...
/**
 * TrueFocus — word-by-word focus animation.
 * Auto-cycles through each word, blurring inactive ones and
 * animating a focus frame around the active word.
 */
