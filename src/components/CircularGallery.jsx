...
const DEFAULT_FONT = 'bold 30px "Space Grotesk"';
...
class App {
  constructor(container, {
    ...
    font = DEFAULT_FONT, scrollSpeed = 2, scrollEase = 0.05
  } = {}) {
...
export default function CircularGallery({
  ...
  font = DEFAULT_FONT, fontUrl, scrollSpeed = 2, scrollEase = 0.05
}) {
  ...
  return (
    <div className="circular-gallery" ref={containerRef} tabIndex={0} role="region"
